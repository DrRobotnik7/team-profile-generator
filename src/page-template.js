...
const generateTeam = team => {
    ...
    const generateManager = manager => {
        return `
        <div class="card employee-card mr-3">
        ...
        <div class="card-body bg-light">
            <ul class="list-group">
                <li class="list-group-item bg-light">ID: ${manager.getId()}</li>
                <li class="list-group-item bg-light">Email: <a href="mailto:${manager.getEmail()}">${manager.getEmail()}</a></li>
                <li class="list-group-item bg-light">Office number: ${manager.getOfficeNumber()}</li>
            </ul>
        </div>
    </div>
        `;
    ...
    <div class="card-body bg-light">
        <ul class="list-group">
            ...
            <li class="list-group-item bg-light">GitHub: <a href="https://github.com/${engineer.getGithub()}" target="_blank" rel="noopener noreferrer">${engineer.getGithub()}</a></li>
        </ul>
    </div>
</div>
        `;
    ...
    <div class="card-body bg-light">
        <ul class="list-group">
            <li class="list-group-item bg-light">ID: ${intern.getId()}</li>
            <li class="list-group-item bg-light">Email: <a href="mailto:${intern.getEmail()}">${intern.getEmail()}</a></li>
            <li class="list-group-item bg-light">School: ${intern.getSchool()}</li>
        </ul>
    </div>
</div>
        `;
